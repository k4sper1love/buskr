...
('c3d4e5f6-7a8b-9c0d-1e2f-3a4b5c6d7e8f', 'Терренкур (река)', 'Тихая и уютная прогулочная зона у реки Малая Алматинка. Идеально для акустики.', ST_SetSRID(ST_MakePoint(76.9602, 43.2215), 4326), 'low', 'active'),
